-- ============================================================================
-- Spine: Master Installation SQL
-- Run this against a fresh Supabase project to set up the complete schema,
-- security layer, and template packs.
--
-- Usage:
--   Connect to your Supabase project's SQL editor and run this entire file.
--   Or via psql: psql <connection_string> -f install.sql
--
-- What's included:
...
--   2. Create your first auth user in Supabase Dashboard → Auth
